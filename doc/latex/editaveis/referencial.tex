...
Outra maneira de representar um jogo é chamado de \textbf{forma normal}. Nesta forma o jogo é representado por uma matriz, onde na linha tem-se as \textbf{estratégias puras} do primeiro jogador e na coluna, as do segundo jogador. No caso do exemplo \ref{ex:renee-v-peter}, o jogo é representado pela tabela %\ref{}
...
\begin{ex}\label{ex:dilema-do-prisioneiro}
